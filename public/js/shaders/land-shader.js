...
const planeGeometry = new THREE.PlaneGeometry(160, 160, 16, 16 );
...
function CalculateSizes(){
  sizes.height = header.offsetHeight;
...
const tick = () =>
{
    if(window.scrollY <= window.innerHeight)//update if in view
    {
      ...
      //var landScale = 0.003;
      //land.scale.x = sizes.width * landScale;
      //land.scale.y = sizes.width * landScale;
      //land.scale.z = sizes.width * landScale;
