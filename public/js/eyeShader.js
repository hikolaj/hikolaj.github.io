...
void main(void)
{
    ...
    fresnelValue = pow(fresnelValue, 3.0);
    //fresnelValue /= 2.0;
...
// Canvas
const canvas = document.querySelector('canvas.EyeShader')
...
// Objects
const pivotSphereGeometry = new THREE.SphereGeometry(0.1, 24, 24);
const pointSphereGeometry = new THREE.SphereGeometry(0.16, 10, 10);
...
scene.add(lidSphere);
//lidSphere.material.side = THREE.DoubleSide;
...
const tick = () =>
{
    ...
    sphereOb1.rotation.y = rotValue*2;
    //sphereOb1.rotation.x = rotValue/2;

    //sphereOb2.rotation.y = rotValue;
    //sphereOb2.rotation.x = -rotValue;

    colorSphere.rotation.z = rotValue/3;
